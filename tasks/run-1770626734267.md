...
```
output/sharma-optics/run-1770626734267/index.html
```
...
2. Call: `curl -X POST "http://localhost:4000/upload?runId=run-1770626734267&slug=sharma-optics"`
